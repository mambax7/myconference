...
//$configurator = new Myconference\Common\Configurator();

$helper->loadLanguage('common');

//handlers
//$categoryHandler     = new Myconference\CategoryHandler($db);
//$downloadHandler     = new Myconference\DownloadHandler($db);
