<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_MYCONFERENCE_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4> <br>

    <p class="even">This module is for creating a Conference event, with various speakers, speeches/presentations, and tracks<br> <br>
    </p>
    ...
    <p class="even">
        Tutorial has been started, but we might need your help! Please check it out the status of the tutorial <a href="https://www.gitbook.com/book/xoops/ZZZZZZZZ-tutorial/" target="_blank">here </a>.
